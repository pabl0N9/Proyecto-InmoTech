      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Buscar..."
            className="pl-10 pr-4 py-2 bg-white/60 border border-gray-200/60 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500/50 transition-all duration-300 w-64"
          />
        ...
        <div className="relative">
          ...
          <ProfileDropdown
            ...
            onOpenSettings={() => { setIsSettingsModalOpen(true); setIsProfileOpen(false); }}
