...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        title: `¡Bienvenido(a), ${userData.nombre_completo || userData.email}!`,
        description: "Has iniciado sesión correctamente.",
        variant: "success"
      })

      // Determinar la ruta de redirección
      // Siempre redirigir a la página principal después del login para evitar problemas de permisos
      let redirectPath = "/"

      // Nota: Si en el futuro se requiere redirección inteligente basada en roles,
      // se puede implementar lógica aquí que verifique permisos antes de redirigir
