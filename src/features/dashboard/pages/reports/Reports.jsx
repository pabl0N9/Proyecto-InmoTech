...
const ReportsContent = () => {
  ...
  const fetchReports = async () => {
    ...
    try {
      ...
      const mapped = rows.map((r) => {
        const propietario = r.inmueble_propietario || r.propietario || r.reporta_nombre || '';
        const responsable = r.responsable_nombre || r.reporta_nombre || '';
        return {
  ...
  const handleViewReport = async (report) => {
    try {
      ...
      detailedReport.propietario = report.propietario || detailedReport.inmueble_propietario || detailedReport.reporta_nombre || ''
      detailedReport.responsable = report.responsable || report.responsable_nombre || detailedReport.responsable_nombre || detailedReport.reporta_nombre || formatResponsableName(detailedReport.reportadoPor)
