  ...
  const [roles, setRoles] = useState([
    {
      ...
      permisos: {
        ...
        gEmpleados: { crear: true, editar: true },
        clientes: { crear: true, ver: true },
        usuarios: { crear: true, editar: true, ver: true },
        reporteInmuebles: { ver: true },
        inmuebles: { crear: true, editar: true, ver: true },
        citas: { crear: true, ver: true },
      },
    },
  ]);
